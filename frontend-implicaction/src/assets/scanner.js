  ...
  window["EXT_LIB_DEF_FUNC_BOWSER"] = function () {
    function t(t) {
      ...
      var i = n(/(ipod|iphone|ipad)/i).toLowerCase(), s = /like android/i.test(t), o = !s && /android/i.test(t),
        u = /nexus\s*[0-6]\s*/i.test(t), a = !u && /nexus\s*[0-9]+/i.test(t), f = /CrOS/.test(t), l = /silk/i.test(t),
        c = /sailfish/i.test(t), h = /tizen/i.test(t), p = /(web|hpw)os/i.test(t), d = /windows phone/i.test(t),
        v = /SamsungBrowser/i.test(t), m = !d && /windows/i.test(t), g = !i && !l && /macintosh/i.test(t),
        y = !o && !c && !h && !p && /linux/i.test(t), b = n(/edge\/(\d+(\.\d+)?)/i), w = n(/version\/(\d+(\.\d+)?)/i),
  ...
  function La(a) {
    ...
    if (a || b) {
      if (!b) {
        b = {
          name: "div",
          attributes: {id: "asprise-web-scan-setup-dialog-wrapper", "class": "asprise-web-scan-dialog-wrapper " + qa},
          children: [{
            name: "div",
            attributes: {
            ...
            children: [{name: "button", attributes: {"class": "top-right-closer", title: "Dismiss this dialog"}}, {
              name: "div",
              attributes: {"class": "asprise-web-scan-setup", style: "margin: auto"},
              children: [{name: "h2", attributes: {text: "Please complete one-time setup"}}, {
                name: "table",
                attributes: {"class": "asprise-web-scan-setup-instruction"},
                children: [{
                  name: "tr",
                  attributes: {"class": "icon"},
                  children: [{name: "td", attributes: {width: "33%", "class": "download"}}, {
                    name: "td",
                    attributes: {width: "33%", "class": "run"}
                  }, {name: "td", attributes: {width: "33%", "class": "enjoy"}}]
                }, {
                  name: "tr",
                  ...
                  children: [{
                    ...
                    children: [{
                      name: "h3",
                      children: [{name: "a", attributes: {href: r, target: "_blank", text: "Download"}}]
                    }, {
                      name: "p",
                      children: [{
                        name: "a",
                      ...
                      }, {name: "span", attributes: {style: "font-size: smaller", text: " \u00b7 "}}, {
                        name: "a",
                        attributes: {
                          style: "font-size: smaller",
                          "class": "underline",
                ...
                name: "p",
                children: [{name: "span", attributes: {text: "Already have the scan app set up? "}}, {
                  name: "a",
                  attributes: {
                    "class": "underline",
